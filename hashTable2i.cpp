...
private:
    ...
    // vector<LinkedList*> hashArray(10005);
    // map< pair<string, int>,
public:
    HashTable();
    ...
    void initializeFileds(LinkedList* x,
...
int HashTable::hashFunction(string currentLocation, int numberOfPassenger)
{
    ...
    for(int i = 0; i < currentLocation.size(); i++)
    {
        ...
        sum += (int)(tolower(currentLocation[i]) - 'a');
...
void HashTable::initializeFileds(LinkedList* x,
                      string name, string phone,
                      double fare, double totalKilometerDriven,
                      string carType, string carNumber,
                      string currentLocation, int numberOfPassenger,
                      int noOfTimesFined,int sumOfFines,
                      double rating)
{
    x->name = name;
    x->phone = phone;
                               ...
                               int noOfTimesFined,int sumOfFines, double rating)
{
    ...
    {
        LinkedList* x = hashArray[index];
        initializeFileds(x, name, phone,
                         fare, totalKilometerDriven,
                         carType, carNumber,
                         currentLocation, numberOfPassenger,
                         noOfTimesFined, sumOfFines,
                         rating);
    }
    else
    {
...
void inputDriversData(HashTable ob)
{
    ...
    ob.insertElements("dipty", "01680536660",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "Banani",
                       4, 2,200, 3.5);

    ob.insertElements("ty", "01680536661",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "banani",
                       4, 2,200, 3.5);

    ob.insertElements("dip", "01680536662",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "Banani",
                       2, 2, 200,3.5);

    ob.insertElements("dity", "01680536663",
                      40.0, 1000.0, "Audi",
                       "dhaka-23", "Mohakhali",
                       6, 2,200, 3.5);
    ob.insertElements("dipty", "01680536664",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "Mohakhali",
                      2, 2,200, 3.5);

    ob.insertElements("dipy", "01680536665",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "Uttara",
                      4, 2,200, 3.5);

    ob.insertElements("dty", "01680536666",
                      40.0, 1000.0, "Audi",
                      "dhaka-23", "Uttara",
                      2, 2, 200,3.5);
}
